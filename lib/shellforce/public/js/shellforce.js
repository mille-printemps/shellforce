...
var executeShellForce = function() {
    ...
    $.ajax({
            ...
            success : function(response) {
                ...
                var codeViewPortContainer = $("<div id='codeViewPortContainer' style='display: none; right: 10px;'><strong>Raw Response</strong><p id='codeViewPort'>"+ response + "</p>")
                
                $("div[id='results']").append(expandAll).append(" | ").
                    append(collapseAll).append(" | ").
                    append(showRawResponse).
                    append(responseListContainer).
                    append(responseBody).
                    append(codeViewPortContainer);
        }
    });
};